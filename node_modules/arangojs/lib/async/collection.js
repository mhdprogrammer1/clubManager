...
class BaseCollection {
    ...
    async create(properties) {
        const res = await this._api.post("/collection", Object.assign({}, properties, { name: this.name, type: this.type }));
        return res.body;
    }
    properties() {
    ...
    async replace(documentHandle, newValue, opts = {}) {
        ...
        const res = await this._api.put(this._documentPath(documentHandle), newValue, opts, headers);
        return res.body;
    }
    async update(documentHandle, newValue, opts = {}) {
        ...
        const res = await this._api.patch(this._documentPath(documentHandle), newValue, opts, headers);
        return res.body;
    }
    async bulkUpdate(newValues, opts) {
        const res = await this._api.patch(`/document/${this.name}`, newValues, opts);
        return res.body;
    }
    async remove(documentHandle, opts = {}) {
        ...
        const res = await this._api.delete(this._documentPath(documentHandle), opts, headers);
        return res.body;
    }
    async list(type = "id") {
    ...
    async all(opts) {
        const res = await this._api.put("/simple/all", Object.assign({}, opts, { collection: this.name }));
    ...
    async first(opts) {
        ...
        const res = await this._api.put("/simple/first", Object.assign({}, opts, { collection: this.name }));
        return res.body.result;
    }
    async last(opts) {
        if (typeof opts === "number") {
        ...
        const res = await this._api.put("/simple/last", Object.assign({}, opts, { collection: this.name }));
        return res.body.result;
    }
    async byExample(example, opts) {
        const res = await this._api.put("/simple/by-example", Object.assign({}, opts, { example, collection: this.name }));
        return new cursor_1.ArrayCursor(this._connection, res.body, res.host);
    }
    async firstExample(example) {
    ...
    async removeByExample(example, opts) {
        const res = await this._api.put("/simple/remove-by-example", Object.assign({}, opts, { example, collection: this.name }));
        return res.body;
    }
    async replaceByExample(example, newValue, opts) {
        const res = await this._api.put("/simple/replace-by-example", Object.assign({}, opts, { example,
            newValue, collection: this.name }));
        return res.body;
    }
    async updateByExample(example, newValue, opts) {
        const res = await this._api.put("/simple/update-by-example", Object.assign({}, opts, { example,
            newValue, collection: this.name }));
        return res.body;
    }
    async lookupByKeys(keys) {
    ...
    async removeByKeys(keys, options) {
    ...
    async index(indexHandle) {
        const res = await this._api.get(`/index/${this._indexHandle(indexHandle)}`);
        return res.body;
    }
    async createIndex(details) {
        const res = await this._api.post("/index", details, {
            collection: this.name
        });
        return res.body;
    }
    async dropIndex(indexHandle) {
        const res = await this._api.delete(`/index/${this._indexHandle(indexHandle)}`);
        return res.body;
    }
    async createCapConstraint(opts) {
        if (typeof opts === "number") {
            opts = { size: opts };
        }
        const res = await this._api.post("/index", Object.assign({}, opts, { type: "cap" }), { collection: this.name });
        return res.body;
    }
    async createHashIndex(fields, opts) {
        ...
        const res = await this._api.post("/index", Object.assign({ unique: false }, opts, { type: "hash", fields: fields }), { collection: this.name });
        return res.body;
    }
    async createSkipList(fields, opts) {
        if (typeof fields === "string") {
            fields = [fields];
        }
        if (typeof opts === "boolean") {
        ...
        const res = await this._api.post("/index", Object.assign({ unique: false }, opts, { type: "skiplist", fields: fields }), { collection: this.name });
        return res.body;
    }
    async createPersistentIndex(fields, opts) {
        if (typeof fields === "string") {
            fields = [fields];
        }
        if (typeof opts === "boolean") {
        ...
        const res = await this._api.post("/index", Object.assign({ unique: false }, opts, { type: "persistent", fields: fields }), { collection: this.name });
        return res.body;
    }
    async createGeoIndex(fields, opts) {
        if (typeof fields === "string") {
            fields = [fields];
        }
        const res = await this._api.post("/index", Object.assign({}, opts, { fields, type: "geo" }), { collection: this.name });
        return res.body;
    }
    async createFulltextIndex(fields, minLength) {
        if (typeof fields === "string") {
            fields = [fields];
        }
        const res = await this._api.post("/index", { fields, minLength, type: "fulltext" }, { collection: this.name });
        return res.body;
    }
    async fulltext(attribute, query, opts = {}) {
        if (opts.index)
            opts.index = this._indexHandle(opts.index);
        const res = await this._api.put("/simple/fulltext", Object.assign({}, opts, { attribute,
...
class DocumentCollection extends BaseCollection {
    ...
    async save(data, opts) {
        ...
        if (this._connection.arangoMajor <= 2) {
            const res = await this._api.post(`/document`, data, Object.assign({}, opts, { collection: this.name }));
            return res.body;
        }
...
class EdgeCollection extends BaseCollection {
    ...
    async _edges(documentHandle, direction) {
    ...
    async traversal(startVertex, opts) {
        const res = await this._api.post("/traversal", Object.assign({}, opts, { startVertex, edgeCollection: this.name }));
        return res.body.result;
    }
}
